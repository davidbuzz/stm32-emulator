...
{  8,  8,    3.30/4096 }, /* PB0 PB0_ADC */ \
{  9,  9,    3.30/4096 }, /* PB1 PB1_ADC */ \
...
#define HAL_VALIDATE_BOARD (!((check_ms5611("ms5611")))?"$CHECK_BARO0_PRESENT":!((check_ms5611("ms5611_ext")))?"$CHECK_BARO1_PRESENT":!((spi_check_register("mpu9250_ext", MPUREG_WHOAMI, MPU_WHOAMI_MPU9250)) || (spi_check_register("icm20602_ext", MPUREG_WHOAMI, MPU_WHOAMI_ICM20602)))?"$CHECK_IMU0_PRESENT":!(((spi_check_register("lsm9ds0_ext_g", LSMREG_WHOAMI, LSM_WHOAMI_L3GD20)) && (spi_check_register("lsm9ds0_ext_am", LSMREG_WHOAMI, LSM_WHOAMI_LSM303D))) || (spi_check_register("icm20948_ext", INV2REG_WHOAMI, INV2_WHOAMI_ICM20948)))?"$CHECK_IMU1_PRESENT":!((spi_check_register("mpu9250", MPUREG_WHOAMI, MPU_WHOAMI_MPU9250)))?"$CHECK_IMU2_PRESENT":nullptr)
...
#define HAL_SERIAL_DEVICE_LIST HAL_OTG1_CONFIG,HAL_USART2_CONFIG,HAL_USART3_CONFIG,HAL_UART4_CONFIG,HAL_UART8_CONFIG,HAL_UART7_CONFIG,HAL_USART6_CONFIG
